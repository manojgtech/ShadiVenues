...
public class CheckAvail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton datepickerbtn=findViewById(R.id.seldatebtn);
        datebox=findViewById(R.id.selectdate);
        ...
        ImageButton datepickerbtn2=findViewById(R.id.seldatebtn2);
        datebox2=findViewById(R.id.selectdate2);
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(getApplicationContext(),
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year,
                                ...
                                datebox2.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year);
